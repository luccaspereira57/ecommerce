 ...
 */
class Ubit_Range_Slider_Control extends WP_Customize_Control {
	/**
	 * The control type.
	 *
	 * @access public
	...
	public function to_json() {
		...
		$this->json['desktop_label'] = esc_html__( 'Desktop', 'ubit' );
		$this->json['tablet_label']  = esc_html__( 'Tablet', 'ubit' );
		$this->json['mobile_label']  = esc_html__( 'Mobile', 'ubit' );
		$this->json['reset_label']   = esc_html__( 'Reset', 'ubit' );
	...
	public function enqueue() {
		wp_enqueue_script(
			'ubit-range-slider',
			UBIT_THEME_URI . 'inc/customizer/custom-controls/range/js/slider-control.js',
		...
		wp_enqueue_style(
			'ubit-range-slider',
			UBIT_THEME_URI . 'inc/customizer/custom-controls/range/css/slider-customizer.css',
			array(),
			ubit_version()
		);
	}
	...
	protected function content_template() {
		?>
		<div class="ubit-range-slider-control">
			<div class="ubit-range-title-area">
				<# if ( data.label || data.description ) { #>
				<div class="ubit-range-title-info">
					<# if ( data.label ) { #>
				...
				<div class="ubit-range-slider-controls">
					<span class="ubit-device-controls">
						<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
							<span class="ubit-device-desktop dashicons dashicons-desktop" data-option="desktop" title="{{ data.desktop_label }}"></span>
						<# } #>

						<# if ( 'undefined' !== typeof ( data.tablet ) ) { #>
							<span class="ubit-device-tablet dashicons dashicons-tablet" data-option="tablet" title="{{ data.tablet_label }}"></span>
						<# } #>

						<# if ( 'undefined' !== typeof ( data.mobile ) ) { #>
							<span class="ubit-device-mobile dashicons dashicons-smartphone" data-option="mobile" title="{{ data.mobile_label }}"></span>
						<# } #>
					</span>

					<span title="{{ data.reset_label }}" class="ubit-reset dashicons dashicons-image-rotate"></span>
				</div>
			</div>

			<div class="ubit-range-slider-areas">
				<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
				<label class="range-option-area" data-option="desktop" style="display: none;">
					<div class="wrapper <# if ( '' !== data.choices['desktop']['unit'] ) { #>has-unit<# } #>">
						<div class="ubit_range_value <# if ( '' == data.choices['desktop']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
						...
						<div class="ubit-slider" data-step="{{ data.choices['desktop']['step'] }}" data-min="{{ data.choices['desktop']['min'] }}" data-max="{{ data.choices['desktop']['max'] }}"></div>
					</div>
				</label>
				<# } #>
				...
				<label class="range-option-area" data-option="tablet" style="display:none">
					<div class="wrapper <# if ( '' !== data.choices['tablet']['unit'] ) { #>has-unit<# } #>">
						<div class="ubit_range_value <# if ( '' == data.choices['tablet']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
						...
						<div class="ubit-slider" data-step="{{ data.choices['tablet']['step'] }}" data-min="{{ data.choices['tablet']['min'] }}" data-max="{{ data.choices['tablet']['max'] }}"></div>
					</div>
				</label>
				<# } #>
				...
				<label class="range-option-area" data-option="mobile" style="display:none;">
					<div class="wrapper <# if ( '' !== data.choices['mobile']['unit'] ) { #>has-unit<# } #>">
						<div class="ubit_range_value <# if ( '' == data.choices['mobile']['unit'] && ! data.choices['desktop']['edit'] ) { #>hide-value<# } #>">
						...
						<div class="ubit-slider" data-step="{{ data.choices['mobile']['step'] }}" data-min="{{ data.choices['mobile']['min'] }}" data-max="{{ data.choices['mobile']['max'] }}"></div>
					</div>
				</label>
				<# } #>
			</div>
