...
var Merlin = (function($){
    ...
    function window_loaded(){
        ...
        select_demo_btn.on( 'click', function() {
			$('[data-callback="install_content"]').css({'display': 'none'});
        ...
        if ($('.merlin__demo').length === 1) {
          $('.merlin__demos').addClass('merlin__demos_center');
          select_demo_btn.hide();
          select_demo_btn.trigger('click');
        }
    }
                ...
                if(typeof response.url !== "undefined"){
                    ...
                    if(response.hash === current_item_hash){
                        ...
                        if ( typeof response.selected_index === "undefined" ) {
                            response.selected_index = current_index;
                        }
